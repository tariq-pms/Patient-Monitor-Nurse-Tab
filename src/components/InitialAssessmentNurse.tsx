  ...
  <Button variant="contained" color="primary" onClick={downloadPdf} sx={{ mb: 2 }}>
    ...
    mx: "auto",
      ...
      <Box sx={{ border: '2px solid #000', p: 0.5, backgroundColor: '#333', color: '#fff' }}>
          <Typography variant="subtitle2" fontWeight="bold">NURSE INITIAL ASSESSMENT</Typography>
        </Box>
        <Box
  sx={{
    display: "flex",
...
>
  ...
  {/* ROW 6: VITALS (Using dynamic data) */}
  <Grid container sx={{ p: 0.5 }}>
    <Grid item xs={3} sx={{ fontSize: '13px',color:'black' }}>Temp: <b>{assessment.vitals.temp}</b></Grid>
    <Grid item xs={3} sx={{ fontSize: '13px',color:'black' }}>Pulse: <b>{assessment.vitals.hr}</b></Grid>
    <Grid item xs={3} sx={{ fontSize: '13px',color:'black' }}>Resp: <b>{assessment.vitals.rr}</b></Grid>
    <Grid item xs={3} sx={{ fontSize: '13px',color:'black' }}>SpO2: <b>{assessment.vitals.spo2}</b></Grid>
   
  </Grid>
  <Grid container sx={{ p: 0.5 }}>
    
    <Grid item xs={3} sx={{ fontSize: '13px',color:'black' }}>Weight: <b>{assessment.anthropometry.weight}</b></Grid>
    <Grid item xs={3} sx={{ fontSize: '13px',color:'black' }}>Length: <b>{assessment.anthropometry.length}</b></Grid>
    <Grid item xs={3} sx={{ fontSize: '13px',color:'black' }}>H.Circumference: <b>{assessment.anthropometry.hc}</b></Grid>
    <Grid item xs={3} sx={{ fontSize: '13px' ,color:'black'}}>Blood Glucose: <b>{assessment.anthropometry.bsl || "—"}</b></Grid>
      ...
      <Table size="small" sx={{ border: '1px solid #000' }}>
        <TableBody>
          {["Dentures", "Hearing Aid", "Jewellery"].map((item) => (
            <TableRow key={item}>
              <TableCell sx={{ border: '1px solid #000', py: 0.2 ,color:'black'}}>{item}</TableCell>
              <TableCell sx={{ border: '1px solid #000', py: 0.2,color:'black' }}>YES <Tick /></TableCell>
              <TableCell sx={{ border: '1px solid #000', py: 0.2,color:'black' }}>NO <Tick checked /></TableCell>
              <TableCell sx={{ border: '1px solid #000', py: 0.2 ,color:'black'}}>Sent Home <Tick /></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
  ...
  <Table size="small">
    <TableBody>
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        ...
        <Grid container sx={{ p: 0.5 }}>
          {[
            "Age over 60", "Impaired Judgement", "Post operative", "Previous Fall", 
            "Sedated", "Muscular Weakness", "Sensory Deficit"
          ].map((risk) => (
            <Grid item xs={3} key={risk} sx={{ color:'black',fontSize: '11px', display: 'flex', alignItems: 'center', mb: 0.5 }}>
              <Tick/> {risk}
            </Grid>
          ))}
      ...
      <Table size="small" sx={{ border: '1px solid #000' }}>
        <TableHead sx={{ backgroundColor: '#eee' }}>
          <TableRow>
            <TableCell sx={{ border: '1px solid #000' ,color:'black'}}>Activity</TableCell>
            <TableCell sx={{ border: '1px solid #000' ,color:'black'}}>Independent</TableCell>
            <TableCell sx={{ border: '1px solid #000' ,color:'black'}}>Assisted</TableCell>
            <TableCell sx={{ border: '1px solid #000' ,color:'black'}}>Dependent</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {["Bathing", "Dressing", "Eating", "Walking"].map(a => (
            <TableRow key={a}>
              <TableCell sx={{ border: '1px solid #000', py: 0.2 ,color:'black'}}>{a}</TableCell>
              <TableCell sx={{ border: '1px solid #000', textAlign: 'center',color:'black' }}><Tick /></TableCell>
              <TableCell sx={{ border: '1px solid #000', textAlign: 'center' ,color:'black'}}><Tick /></TableCell>
              <TableCell sx={{ border: '1px solid #000', textAlign: 'center' ,color:'black'}}><Tick checked /></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
    ...
    mx: "auto",
      ...
      <Box sx={{ border: '1px solid #000', mt: 1, p: 1 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mt: 1 }}>
          ...
          <Box sx={{ flex: 1, height: '20px', mx: 2, background: 'linear-gradient(to right, green, yellow, red)', border: '1px solid #000' }} />
...
<Table size="small" sx={{ border: '1px solid #000' }}>
  <TableHead sx={{ backgroundColor: '#eee' }}>
    <TableRow>
      ...
      <TableCell sx={{ border: '1px solid #000', fontWeight: 'bold', fontSize: '11px', py: 0.5 ,color:'black'}}>Dose</TableCell>
      <TableCell sx={{ border: '1px solid #000', fontWeight: 'bold', fontSize: '11px', py: 0.5,color:'black' }}>Frequency</TableCell>
      <TableCell sx={{ border: '1px solid #000', fontWeight: 'bold', fontSize: '11px', py: 0.5 ,color:'black'}}>Date/Time of last dose</TableCell>
    </TableRow>
  </TableHead>
  <TableBody>
    {assessment.medications && assessment.medications.length > 0 ? (
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        <Typography variant="caption" sx={{ color:'black',backgroundColor: '#eee', display: 'block', px: 1, fontWeight: 'bold', borderBottom: '1px solid #000' }}>
          Vulnerable Patient
        </Typography>
        {[
          { label: "Age > 65 years", val: false },
          { label: "Age < 12 years", val: true },
          { label: "Mentally Challenged", val: false },
          { label: "Physically Handicapped / Unable to perform ADL", val: false },
        ].map((item, index) => (
          <Grid container key={index} sx={{ borderBottom: index === 3 ? 0 : '1px solid #000', px: 1 }}>
            <Grid item xs={8} sx={{ fontSize: '12px' ,color:'black'}}>{item.label}</Grid>
            <Grid item xs={2} sx={{ fontSize: '12px',color:'black' }}>YES <Tick checked={item.val} /></Grid>
            <Grid item xs={2} sx={{ fontSize: '12px',color:'black' }}>NO <Tick checked={!item.val} /></Grid>
          </Grid>
        ))}
      </Box>
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        <Typography variant="caption" sx={{ backgroundColor: '#eee',color:'black', display: 'block', px: 1, fontWeight: 'bold', borderBottom: '1px solid #000' }}>
          Special Assessment for Infectious Disease
        </Typography>
        <Grid container sx={{ p: 0.5 }}>
          <Grid item xs={3} sx={{ fontSize: '11px' ,color:'black'}}>Isolation required <Tick /></Grid>
          <Grid item xs={3} sx={{ fontSize: '11px',color:'black' }}>PPE required <Tick /></Grid>
          <Grid item xs={3} sx={{ fontSize: '11px' ,color:'black'}}>Vaccinated <Tick checked /></Grid>
          <Grid item xs={3} sx={{ fontSize: '11px',color:'black' }}>Skin lesions/itching <Tick /></Grid>
        </Grid>
      </Box>

     
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        <Box sx={{ borderBottom: '1px solid #000', p: 0.5 }}>
          <Typography variant="caption" fontWeight="bold" sx={{color:'black'}}>Neurological Status:</Typography>
          <Grid container sx={{ mt: 0.5 }}>
            <Grid item xs={4} sx={{ fontSize: '12px',color:'black' }}>Conscious <Tick checked /></Grid>
            <Grid item xs={4} sx={{ fontSize: '12px',color:'black' }}>Semi-Conscious <Tick /></Grid>
            <Grid item xs={4} sx={{ fontSize: '12px',color:'black' }}>Comatosed <Tick /></Grid>
          </Grid>
        </Box>
        <Box sx={{ p: 0.5 }}>
          <Typography variant="caption" fontWeight="bold" sx={{color:'black'}}>Psychological Status:</Typography>
          <Grid container sx={{ mt: 0.5 }}>
            {["Anxious", "Depressed", "Angry", "Combative", "Sleep Disorder"].map(status => (
              <Grid item xs={2.4} key={status} sx={{ fontSize: '11px',color:'black' }}>
                {status} <Tick />
              </Grid>
            ))}
          </Grid>
    ...
    {assessment.otherNeeds && (
      ...
      <Box sx={{ border: '2px solid #000', p: 1, backgroundColor: '#f9f9f9' }}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={4}>
            <Typography variant="caption"sx={{color:' black'}}><b>Designation:</b> Staff Nurse</Typography>
          </Grid>
          <Grid item xs={6}>
                ...
                {[
                  ...
                  <Grid container key={i} sx={{ borderBottom: "1px solid #000" }}>
                    <Grid item xs={4} sx={{ p: 0.5, borderRight: "1px solid #000" }}>
                      <Typography fontSize={12} sx={{color:'black'}}>{label}</Typography>
                    </Grid>
                    <Grid item xs={8} sx={{ p: 0.5 }}>
                      <Typography fontSize={12} sx={{color:'black'}}>{value || "—"}</Typography>
                    </Grid>
                  </Grid>
                ))}
              </Box>
