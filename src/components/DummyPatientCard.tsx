...
export interface DummyPatientDetails {
    ...
    <Box  width={{
      ...
      > 
        ...
        <Card style={{ backgroundColor:darkTheme?'#34495F':'#FFFFFF', borderRadius: "18px", height:"300px", boxShadow: `0px 0px 10px #FFD0D0`,border: `6px solid ${isBlinking ? '#FC8A8A' : '#F9F9F9'}` }}> 
            <Stack width={'100%'} height={'100%'}>
    ...
    <div style={{marginTop:'7%'}}><Typography variant='h6' color={darkTheme?'#CEE6FF':"#124D81"} paddingLeft={'10%'} style={{fontWeight: 'bold', fontFamily: 'Helvetica'}}>Baby Temp</Typography>
         ...
         <div style={{display:'flex', textAlign:'center', justifyContent:'center'}}>
          <Typography variant='h1' color={darkTheme?'#CEE6FF':"#124D81"} >34.3</Typography>
           <Typography variant='subtitle1' color={darkTheme?'#CEE6FF':"#124D81"}  >℃</Typography>
        <Typography variant='subtitle1' color={darkTheme?'#CEE6FF':"#124D81"} paddingTop={'25%'} > 36</Typography>
                            </div>
    </Box>
    <Box width={'25%'} >
    <div style={{marginTop:'15%'}}><Typography variant='subtitle1' color={darkTheme?'#A0CCFB':"#4B7193"} style={{fontWeight: 'bold', fontFamily: 'Helvetica'}} >Heater Temp</Typography></div>
                            ...
                            <div style={{display:'flex', textAlign:'center', justifyContent:'center'}}>
                              <Typography variant='h2' color={darkTheme?'#A0CCFB':"#4B7193"} >34.3</Typography>
                                <Typography variant='subtitle1' color={darkTheme?'#A0CCFB':"#4B7193"} paddingTop={'13%'} paddingLeft={'3%'}> %</Typography>
                            </div>
    </Box>
    ...
    <Box width={'25%'} > <div style={{marginTop:'15%'}}><Typography variant='subtitle1' style={{fontWeight: 'bold', fontFamily: 'Helvetica'}} color={darkTheme?'#A0CCFB':"#124D81"}  paddingLeft={'20%'}>Alarm <FontAwesomeIcon icon={faBell } color= {darkTheme?'#A0CCFB':'#124D81'}/></Typography>
                     ...
                     <div style={{display:'flex', textAlign:'center', justifyContent:'center'}}>
                    <Typography  variant='subtitle1' color={darkTheme?'white':"#FF7354"} sx={{fontWeight:"bold"}} paddingTop={'10%'} > Test Device </Typography> 
                           </div></Box>
</Stack>
...
<Stack height={'50%'} width={'100%'} marginTop={'5%'} direction={'row'}>
    <Box width={'25%'} ><div style={{marginTop:'7%'}}><Typography variant='subtitle1' color={darkTheme?'#B6C8F8':"#3C89C0"} style={{fontWeight: 'bold', fontFamily: 'Helvetica'}}  paddingLeft={'10%'}>Heart Rate</Typography></div>
                            ...
                            <div style={{display:'flex', textAlign:'center',paddingLeft:'8%', justifyContent:'left'}}>
                               <Typography variant='h4' color={darkTheme?'#B6C8F8':"#3C89C0"} > 80</Typography>
                               <Typography variant='subtitle2' color={darkTheme?'#B6C8F8':"#3C89C0"} paddingTop={'15%'} paddingLeft={'3%'}> BPM</Typography>
                           </div></Box>
    <Box width={'25%'} ><div style={{marginTop:'7%'}}><Typography variant='subtitle1' color={darkTheme?'#B6C8F8':"#3C89C0"} style={{fontWeight: 'bold', fontFamily: 'Helvetica'}} paddingLeft={'10%'}>Spo2</Typography></div>
                            ...
                            <div style={{display:'flex', textAlign:'center', paddingLeft:'6%', justifyContent:'left'}}>
                               ...
                               <Typography variant='h4' color={darkTheme?'#B6C8F8':"#3C89C0"} > 92</Typography>
                               <Typography variant='subtitle2' color={darkTheme?'#B6C8F8':"#3C89C0"} paddingTop={'15%'} paddingLeft={'3%'}>  %</Typography>
                           </div></Box>
    <Box width={'25%'} ><div style={{marginTop:'7%'}}><Typography variant='subtitle2'  color={darkTheme?'#B6C8F8':"#3C89C0"} style={{fontWeight: 'bold', fontFamily: 'Helvetica'}} paddingLeft={'10%'}>RR</Typography></div>
                            {/* <Typography variant='subtitle2' color={"#A8C5D4"} marginTop={'10px'} paddingTop={'4%'}>Heater Temp %</Typography> */}
                            <div style={{display:'flex', textAlign:'center', paddingLeft:'6%', justifyContent:'left'}}>
                              <Typography variant='h4' color={darkTheme?'#B6C8F8':"#3C89C0"} > 44</Typography>
                               <Typography variant='subtitle2' color={darkTheme?'#B6C8F8':"#3C89C0"} paddingTop={'15%'} paddingLeft={'3%'}> BPM</Typography>
                           </div></Box>
    <Box width={'25%'} ><div style={{marginTop:'7%'}}><Typography variant='subtitle2'  color={darkTheme?'#A0CCFB':"#38AAC3"}  style={{fontWeight: 'bold', fontFamily: 'Helvetica'}}  paddingLeft={'10%'}>Weight</Typography></div>
                            {/* <Typography variant='subtitle2' color={"#A8C5D4"} marginTop={'10px'} paddingTop={'4%'}>Heater Temp %</Typography> */}
                            <div style={{display:'flex', textAlign:'center', paddingLeft:'6%', justifyContent:'left'}}>
                           <Typography variant='h4' color={darkTheme?'#A0CCFB':"#38AAC3"} > 1.2</Typography>
                            <Typography variant='subtitle1' color={darkTheme?'#A0CCFB':"#38AAC3"} paddingTop={'10%'} paddingLeft={'3%'}> KG</Typography>
                           </div></Box>
</Stack>
                </Stack>
               <Stack direction={'row'} display={'flex'} width={'100%'} borderTop={'1px solid #E4E4E4'} height={'10%'} paddingTop={'1.5%'} justifyContent={'space-between'}>
                    <Box marginLeft={'10px'}>
                        <Typography variant="subtitle2" style={{fontWeight: 'bold', fontFamily: 'Helvetica'}} color={darkTheme?'white':'#7E7E7E'}>INC-100 </Typography>
                    </Box>
                    <Box marginLeft={'20px'}>
                        <Typography variant="subtitle2"  style={{fontWeight: 'bold', fontFamily: 'Helvetica'}} color={darkTheme?'white':'#7E7E7E'}>Jessica Adams</Typography>
                    </Box>
                    <Box marginRight={'20px'}>
                        <Typography variant="subtitle2"   style={{fontWeight: 'bold', fontFamily: 'Helvetica'}} color={darkTheme?'white':'#7E7E7E'}>DOB</Typography> 
                    </Box>                             
                </Stack>
            </Stack>
