...
export const ConsentForms: React.FC<ConsentFormProps> = (props) => {
  ...
  // NOTE: In production, use a more secure auth method
  const FHIR_AUTH = "Basic " + btoa("fhiruser:change-password");

  // Fetch saved discharge summaries
  useEffect(() => {
    const fetchSummaries = async () => {
      if (!props.patient_id) return;
      try {
        // LOINC 11490-0 is "Physician discharge summary"
        const response = await fetch(`${FHIR_URL}/DocumentReference?subject=Patient/${props.patient_id}&type=http://loinc.org|11490-0&_sort=-date`, {
          headers: { 'Authorization': FHIR_AUTH }
        });
        if (response.ok) {
          const data = await response.json();
          if (data.entry) {
            setSavedSummaries(data.entry.map((e: any) => e.resource));
          }
        }
      } catch (err) {
    ...
    fetchSummaries();
  }, [props.patient_id, saveSuccess]); // Re-fetch on save success if passed down or triggered

  const handleViewSummary = (resource: any) => {
    try {
      const attachment = resource.content[0].attachment;
      // Decode safely
      const jsonString = decodeURIComponent(atob(attachment.data).split('').map(function (c) {
      ...
      alert("Error opening saved summary.");
    }
  };
...
I ............................................................ aged ................ years, female / male residing at ................................................................................................................................................................................................................................... state that myself / my ........................................................ (relation) (Mr./Mrs. ............................................................ aged ................ years residing)....................................................................................................................is under the treatment of Dr. ....................................................................................`;
  ...
  const handleFormCardClick = (item: any) => {
    if (item.label === "Discharge Summary") {
      setOpenDischargeModal(true);
    } else {
