...
const labelSx = { fontSize: "13px", fontWeight: 500, color: "#475569", mb: 0.5 };
...
const SignatureCard = ({ 
  ...
  <Box sx={{ p: 2, border: '1px dashed #CED4DA', borderRadius: '8px', backgroundColor: '#F8F9FA', display: 'flex', flexDirection: 'column', gap: 0.5 }}>
    <Typography sx={{ fontSize: '12px', color: '#666', fontWeight: 600, textTransform: 'uppercase' }}>
      {role}
    </Typography>

    {isActive ? (
      <Box sx={{ bgcolor: '#fff', border: '1px solid #eee', borderRadius: '4px', my: 1 }}>
        <SignatureCanvas
      ...
      <Typography sx={{ fontSize: '16px', color: '#0F2B45', fontWeight: 700 }}>
        {name === "-" ? "Electronically Signed" : name}
      </Typography>
    )}

    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
      <CheckCircleIcon sx={{ fontSize: 16, color: isActive ? '#CED4DA' : '#2F9E44' }} />
      <Typography sx={{ fontSize: '13px', color: '#495057' }}>{dateTime}</Typography>
    </Box>
  </Box>
);
...
<Grid container spacing={3} sx={{ mt: 1 }}>
    ...
    <Typography sx={{ fontSize: 14, fontWeight: 700, mt: 4, mb: 2 }}>Maternal Details</Typography>
        <Grid container spacing={3}>
          <Grid item xs={12} md={4}>
            ...
            <TextField fullWidth placeholder="Name" sx={formInputSx} />
          </Grid>
          <Grid item xs={12} md={4}>
            <Typography sx={labelSx}>Mother's Age (Years)</Typography>
            <TextField fullWidth placeholder="e.g. 32" sx={formInputSx} />
          </Grid>
          <Grid item xs={12} md={4}>
    ...
    <Box sx={{ mt: 3 }}>
      <TextField
        ...
        placeholder="e.g. Pre-eclampsia, DCDA/TT..."
        fullWidth
        multiline
        rows={2}
      />
    ...
    {/* ---- Multiple Gestation + Delivery Indication ---- */}
    <Grid container spacing={2} >
      <Grid item xs={12} md={6}>
        <TextField
          label="Multiple Gestation"
          placeholder="e.g. Twin I/Singleton"
          fullWidth
        />
      </Grid>
        ...
        <Grid item xs={6} md={4} key={label}>
          <Box
            sx={{
              ...
              alignItems: "center",
              justifyContent: "space-between",
              backgroundColor: exam.skin.includes(label) ? "#E7F1FD" : "#FFFFFF",
            }}
          >
...
>
 ...
 mt: 0
    ...
    <Button onClick={downloadPDF} variant="contained" sx={{ mb: 2 }}>
      Download
    </Button>
</Box>
      ...
      <Box mt={3}>
        ...
        <Box sx={{ border: "1px solid #000", p: 2 }}>
          {report.planOfCare?.activities?.length > 0 ? (
            report.planOfCare.activities.map((item: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | null | undefined, i: Key | null | undefined) => (
