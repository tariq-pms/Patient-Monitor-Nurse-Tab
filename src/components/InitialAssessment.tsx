...
const handleMicClick = () => {
  ...
  // Add : { checked: boolean } to define the prop type
const Tick = ({ checked }: { checked: boolean }) => (
  <Box component="span" sx={{ 
    ...
    // Added verticalAlign to ensure it lines up with text in the PDF
...
const systematicExamPayload = {
  ...
  const carePlanPayload = {
    ...
    activity: [
      ...
      // ✅ Fix: Split the string by commas and map the resulting array
      ...(typeof planOfCare.investigations === "string" 
        ? planOfCare.investigations.split(",") 
        : planOfCare.investigations
      )
        .filter((inv: string) => inv.trim() !== "") // Remove empty entries
        .map((inv: string) => ({
          detail: {
            status: "not-started",
...
// 🟢 ANTHROPOMETRY
  ...
  function addProvisional(_chip: string): void {
    throw new Error("Function not implemented.");
  }

  function addInvestigation(_chip: string): void {
    throw new Error("Function not implemented.");
  }

  function addTreatent(_chip: string): void {
    throw new Error("Function not implemented.");
  }
...
<Accordion sx={{
  ...
  {[
    { label: "Temp (°C)", key: "temp" as keyof VitalSigns, color: "#E03131" },
    { label: "HR (bpm)", key: "hr" as keyof VitalSigns, color: "#2F9E44" },
    { label: "RR (bpm)", key: "rr" as keyof VitalSigns, color: "#F08C00" },
    { label: "SpO₂ (%)", key: "spo2" as keyof VitalSigns, color: "#1C7ED6" }, // blue
  ].map((item) => (
...
>
 ...
 mt: 0
    ...
    <div ref={reportRef}>
    <Card sx={{backgroundColor:'#fff', p: 2, fontFamily: "Arial, sans-serif", border: '1px solid #000', maxWidth: '900px', mx: 'auto', color: '#000', borderRadius: 0, boxShadow: 'none' }}>
      
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
        <Box sx={{ border: '2px solid #000', p: 0.5, backgroundColor: '#333', color: '#fff' }}>
          <Typography variant="subtitle2" fontWeight="bold">DOCTORS INITIAL ASSESSMENT</Typography>
        </Box>
        <Box
  sx={{
    display: "flex",
...
>
    ...
    >
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        <Grid container>
          <Grid item xs={5} sx={{ borderRight: '1px solid #000', p: 0.5 }}>
            <Typography fontSize={11}>Allergy: YES / NO <strong>__________</strong></Typography>
            <Typography fontSize={11}>Blood Group RH factor: <strong>__________</strong></Typography>
            <Typography fontSize={11}>Vulnerable Patient: YES / NO <strong>__________</strong></Typography>
          </Grid>
          <Grid item xs={7} sx={{ p: 0.5 }}>
            ...
            <Typography fontSize={10}>Alert: __________________________________________________</Typography>
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        <Grid container sx={{ backgroundColor: '#eee', borderBottom: '1px solid #000', fontWeight: 'bold' }}>
          ...
          <Grid item xs={4} sx={{ px: 1 }}>Duration of Chief Complaint</Grid>
        </Grid>
        {[
          { id: 1, c: "Thick MSL", d: "Since birth" },
          { id: 2, c: "RD+, SCR+", d: "Since birth" },
          { id: 3, c: "Meconium Stained Cord", d: "—" }
        ].map((item, i) => (
          <Grid container key={i} sx={{ borderBottom: i === 2 ? 0 : '1px solid #eee' }}>
            <Grid item xs={1} sx={{ borderRight: '1px solid #000', textAlign: 'center', py: 0.5 }}>{item.id}</Grid>
            <Grid item xs={7} sx={{ borderRight: '1px solid #000', px: 1, py: 0.5 }}>{item.c}</Grid>
            <Grid item xs={4} sx={{ px: 1, py: 0.5 }}>{item.d}</Grid>
          </Grid>
        ))}
      </Box>
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        ...
        <Box sx={{ p: 1, minHeight: '40px' }}>
          <Typography fontSize={11}>Patient with above complaint admitted in NICU for further management and treatment.</Typography>
        </Box>
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        ...
        <Grid container sx={{ borderBottom: '1px solid #000' }}>
          <Grid item xs={4} sx={{ borderRight: '1px solid #000', p: 0.5 }}>Type of Birth: <strong>FTND</strong></Grid>
          <Grid item xs={4} sx={{ borderRight: '1px solid #000', p: 0.5 }}>Date of Birth: <strong>19/12/25</strong></Grid>
          <Grid item xs={4} sx={{ p: 0.5 }}>Place of Birth: <strong>NICU Hosp.</strong></Grid>
        </Grid>
        <Grid container sx={{ borderBottom: '1px solid #000' }}>
          <Grid item xs={4} sx={{ borderRight: '1px solid #000', p: 0.5 }}>Cried immediately after Birth: YES <Tick checked={true}/> / NO <Tick checked={false} /></Grid>
          <Grid item xs={4} sx={{ borderRight: '1px solid #000', p: 0.5 }}>Birth Weight: <strong>2.6 kg</strong></Grid>
          <Grid item xs={4} sx={{ p: 0.5 }}>GA: <strong>Full Term</strong></Grid>
        </Grid>
        <Box sx={{ p: 0.5 }}>NICU Admission: YES <Tick checked={true}/> / NO if yes reason: <strong>MSL (Thick)</strong></Box>
      </Box>
  ...
  {/* Row 1: Anthropometry Data (HC, Weight, Length) */}
  <Grid container sx={{ p: 0.5, borderBottom: '1px solid #eee' }}>
    <Grid item xs={3} sx={{ fontSize: 10 }}>
    ...
    <Grid item xs={3} sx={{ fontSize: 10 }}>
      BMI: <strong>_______</strong>
    </Grid>
  </Grid>

  {/* Row 2: Vitals & General Exam */}
  <Grid container sx={{ p: 0.5 }}>
    <Grid item xs={6} sx={{ fontSize: 10 }}>
      Level of Consciousness: <strong>{report?.generalExam?.["Level of Consciousness"] || "___"}</strong>
    </Grid>
    <Grid item xs={3} sx={{ fontSize: 10 }}>
    ...
    <Grid item xs={6} sx={{ fontSize: 10, mt: 0.5 }}>
      Cyanosis: <strong>{report?.generalExam?.["Cyanosis"] || "None"}</strong>
    </Grid>
    <Grid item xs={6} sx={{ fontSize: 10, mt: 0.5 }}>
      SpO2: <strong>{report?.vitals?.["Oxygen Saturation"] || "___"}</strong>
    </Grid>
    
    <Grid item xs={12} sx={{ fontSize: 10, mt: 0.5 }}>
  ...
  <Table size="small" sx={{ '& td': { border: '1px solid #000', fontSize: '10px', p: 0.5 } }}>
    <TableBody>
      {/* Cardio Vascular Row */}
      <TableRow>
        <TableCell sx={{ fontWeight: 'bold', width: '20%', color: 'black' }}>Cardio Vascular</TableCell>
        <TableCell colSpan={2} sx={{ color: 'black' }}>
          {report?.systematicExam?.["Cardiovascular Findings"] || "S1 S2: (+) Normal, Rhythm: Regular, Murmur: NO"}
        </TableCell>
      </TableRow>

      {/* Respiratory Row */}
      <TableRow>
        <TableCell sx={{ fontWeight: 'bold', color: 'black' }}>Respiratory</TableCell>
        <TableCell colSpan={2} sx={{ color: 'black' }}>
          {report?.systematicExam?.["Respiratory Findings"] || "RS: AEBE (+), Air Entry: B/L, Type: Tachypnea"}
        </TableCell>
      </TableRow>

      {/* Gastrointestinal Row */}
      <TableRow>
        <TableCell sx={{ fontWeight: 'bold', color: 'black' }}>Gastrointestinal</TableCell>
        <TableCell colSpan={2} sx={{ color: 'black' }}>
          {report?.systematicExam?.["GI Findings"] || "P/A: Soft, No Organomegaly, B/S: Present"}
        </TableCell>
      </TableRow>

      {/* Neurological Row */}
      <TableRow>
        <TableCell sx={{ fontWeight: 'bold', color: 'black' }}>Neurological</TableCell>
        <TableCell sx={{ width: '40%', color: 'black' }}>
          LOC: {report?.generalExam?.["Level of Consciousness"] || "CTA good"}
        </TableCell>
        <TableCell sx={{ width: '40%', color: 'black' }}>
          Other: {report?.systematicExam?.["CNS Findings"] || "Pupils: B/L Reactive"}
        </TableCell>
      </TableRow>

      {/* Genitourinary Row (New dynamic row based on your console log) */}
      <TableRow>
        <TableCell sx={{ fontWeight: 'bold', color: 'black' }}>Genitourinary</TableCell>
        <TableCell colSpan={2} sx={{ color: 'black' }}>
          {report?.systematicExam?.["Genitourinary Findings"] || "-"}
        </TableCell>
      </TableRow>
    </TableBody>
  </Table>
      ...
      <Box sx={{ border: '1px solid #000', p: 1 }}>
        <Grid container>
          ...
          <Grid item xs={6}>
            <Typography fontSize={11}>Time: <strong>9:00 AM</strong></Typography>
          </Grid>
          <Grid item xs={12} sx={{ mt: 2 }}>
            <Typography fontSize={11}>Sign: ___________________________</Typography>
          </Grid>
        </Grid>
