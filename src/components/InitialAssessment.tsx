...
const handleMicClick = () => {
  ...
  const Tick = ({ checked }) => (
    <Box component="span" sx={{ 
      ...
      border: '1px solid #000', width: 14, height: 14, mr: 0.5, fontSize: '11px',
  ...
  const FormHeader = ({ label }) => (
    <Typography variant="caption" fontWeight="bold" sx={{ backgroundColor: '#ccc', display: 'block', px: 1, borderBottom: '1px solid #000', textTransform: 'uppercase' }}>
      {label}
    </Typography>
  );
useEffect(() => {
...
>
  ...
  >
    ...
    >
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        ...
        <Grid container sx={{ p: 0.5, borderBottom: '1px solid #000' }}>
          <Grid item xs={3}>Alcohol: <Tick/></Grid>
          <Grid item xs={3}>Smoking: <Tick/></Grid>
          <Grid item xs={3}>Drug Addiction: <Tick/></Grid>
      ...
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
        ...
        <Grid container sx={{ borderBottom: '1px solid #000' }}>
          <Grid item xs={4} sx={{ borderRight: '1px solid #000', p: 0.5 }}>Cried immediately after Birth: YES <Tick checked={true}/> / NO <Tick/></Grid>
    ...
    <Card sx={{backgroundColor:'#fff', p: 2, fontFamily: "Arial, sans-serif", border: '1px solid #000', maxWidth: '900px', mx: 'auto', color: '#000', borderRadius: 0, boxShadow: 'none' }}>
      ...
      {/* SECTION: GESTATIONAL AGE & DELIVERY DATES */}
      <Box sx={{ border: '1px solid #000', mb: 1 }}>
