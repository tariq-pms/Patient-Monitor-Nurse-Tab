...
var MRT_FilterOptionMenu = ({ anchorEl, header, onSelect, setAnchorEl, setFilterValue, table }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Menu_default, Object.assign({ anchorEl, anchorOrigin: { vertical: "center", horizontal: "right" }, onClose: () => setAnchorEl(null), open: !!anchorEl, MenuListProps: {
    ...
    onSelectFilterMode: handleSelectFilterMode,
    table
  })) !== null && _d !== void 0 ? _d : internalFilterOptions.map(({ option, label, divider, symbol }, index) => (0, import_jsx_runtime.jsxs)(MenuItem_default, Object.assign({ divider, onClick: () => handleSelectFilterMode(option), selected: option === filterOption, sx: {
    alignItems: "center",
    display: "flex",
    gap: "2ch",
    my: 0,
    py: "6px"
  }, value: option }, { children: [(0, import_jsx_runtime.jsx)(Box_default, Object.assign({ sx: { fontSize: "1.25rem", width: "2ch" } }, { children: symbol })), label] }), index)) }));
};
...
var MRT_ColumnActionMenu = ({ anchorEl, header, setAnchorEl, table }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Menu_default, Object.assign({ anchorEl, open: !!anchorEl, onClose: () => setAnchorEl(null), MenuListProps: {
    dense: density === "compact"
    ...
    enableSortingRemoval !== false && (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: !column.getIsSorted(), onClick: handleClearSort, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(ClearAllIcon2, {}) }), localization.clearSort] })) }), 0),
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: column.getIsSorted() === "asc", onClick: handleSortAsc, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(SortIcon2, { style: { transform: "rotate(180deg) scaleX(-1)" } }) }), (_e = localization.sortByColumnAsc) === null || _e === void 0 ? void 0 : _e.replace("{column}", String(columnDef.header))] })) }), 1),
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ divider: enableColumnFilters || enableGrouping || enableHiding, disabled: column.getIsSorted() === "desc", onClick: handleSortDesc, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(SortIcon2, {}) }), (_f = localization.sortByColumnDesc) === null || _f === void 0 ? void 0 : _f.replace("{column}", String(columnDef.header))] })) }), 2)
  ].filter(Boolean), enableColumnFilters && column.getCanFilter() && [
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: !column.getFilterValue(), onClick: handleClearFilter, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(FilterListOffIcon2, {}) }), localization.clearFilter] })) }), 0),
    (0, import_jsx_runtime.jsxs)(MenuItem_default, Object.assign({ disabled: showColumnFilters && !enableColumnFilterModes, divider: enableGrouping || enableHiding, onClick: showColumnFilters ? handleOpenFilterModeMenu : handleFilterByColumn, sx: commonMenuItemStyles }, { children: [(0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(FilterListIcon2, {}) }), (_g = localization.filterByColumn) === null || _g === void 0 ? void 0 : _g.replace("{column}", String(columnDef.header))] })), showFilterModeSubMenu && (0, import_jsx_runtime.jsx)(IconButton_default, Object.assign({ onClick: handleOpenFilterModeMenu, onMouseEnter: handleOpenFilterModeMenu, size: "small", sx: { p: 0 } }, { children: (0, import_jsx_runtime.jsx)(ArrowRightIcon2, {}) }))] }), 1),
    showFilterModeSubMenu && (0, import_jsx_runtime.jsx)(MRT_FilterOptionMenu, { anchorEl: filterMenuAnchorEl, header, onSelect: handleFilterByColumn, setAnchorEl: setFilterMenuAnchorEl, table }, 2)
  ].filter(Boolean), enableGrouping && column.getCanGroup() && [
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ divider: enablePinning, onClick: handleGroupByColumn, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(DynamicFeedIcon2, {}) }), (_h = localization[column.getIsGrouped() ? "ungroupByColumn" : "groupByColumn"]) === null || _h === void 0 ? void 0 : _h.replace("{column}", String(columnDef.header))] })) }), 0)
  ], enablePinning && column.getCanPin() && [
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: column.getIsPinned() === "left" || !column.getCanPin(), onClick: () => handlePinColumn("left"), sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(PushPinIcon2, { style: { transform: "rotate(90deg)" } }) }), localization.pinToLeft] })) }), 0),
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: column.getIsPinned() === "right" || !column.getCanPin(), onClick: () => handlePinColumn("right"), sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(PushPinIcon2, { style: { transform: "rotate(-90deg)" } }) }), localization.pinToRight] })) }), 1),
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: !column.getIsPinned(), divider: enableHiding, onClick: () => handlePinColumn(false), sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(PushPinIcon2, {}) }), localization.unpin] })) }), 2)
  ], enableColumnResizing && column.getCanResize() && [
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: !columnSizing[column.id], onClick: handleResetColumnSize, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(RestartAltIcon2, {}) }), localization.resetColumnSize] })) }), 0)
  ], enableHiding && [
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: !column.getCanHide(), onClick: handleHideColumn, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(VisibilityOffIcon2, {}) }), (_j = localization.hideColumn) === null || _j === void 0 ? void 0 : _j.replace("{column}", String(columnDef.header))] })) }), 0),
    (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disabled: !Object.values(columnVisibility).filter((visible) => !visible).length, onClick: handleShowAllColumns, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(ViewColumnIcon2, {}) }), (_k = localization.showAllColumns) === null || _k === void 0 ? void 0 : _k.replace("{column}", String(columnDef.header))] })) }), 1)
  ]] }));
};
var MRT_RowActionMenu = ({ anchorEl, handleEdit, row, setAnchorEl, table }) => {
  ...
  const { density } = getState();
  return (0, import_jsx_runtime.jsxs)(Menu_default, Object.assign({ anchorEl, open: !!anchorEl, onClick: (event) => event.stopPropagation(), onClose: () => setAnchorEl(null), MenuListProps: {
    dense: density === "compact"
  } }, { children: [enableEditing instanceof Function ? enableEditing(row) : enableEditing && (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ onClick: handleEdit, sx: commonMenuItemStyles }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: commonListItemStyles }, { children: [(0, import_jsx_runtime.jsx)(ListItemIcon_default, { children: (0, import_jsx_runtime.jsx)(EditIcon2, {}) }), localization.edit] })) })), renderRowActionMenuItems === null || renderRowActionMenuItems === void 0 ? void 0 : renderRowActionMenuItems({
    row,
    table,
    closeMenu: () => setAnchorEl(null)
  })] }));
...
var MRT_LinearProgressBar = ({ isTopToolbar, table }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Collapse_default, Object.assign({ in: isLoading || showProgressBars, mountOnEnter: true, unmountOnExit: true, sx: {
...
var MRT_ColumnPinningButtons = ({ column, table }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Box_default, Object.assign({ sx: { minWidth: "70px", textAlign: "center" } }, { children: column.getIsPinned() ? (0, import_jsx_runtime.jsx)(Tooltip_default, Object.assign({ arrow: true, title: localization.unpin }, { children: (0, import_jsx_runtime.jsx)(IconButton_default, Object.assign({ onClick: () => handlePinColumn(false), size: "small" }, { children: (0, import_jsx_runtime.jsx)(PushPinIcon2, {}) })) })) : (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)(Tooltip_default, Object.assign({ arrow: true, title: localization.pinToLeft }, { children: (0, import_jsx_runtime.jsx)(IconButton_default, Object.assign({ onClick: () => handlePinColumn("left"), size: "small" }, { children: (0, import_jsx_runtime.jsx)(PushPinIcon2, { style: {
    transform: "rotate(90deg)"
  } }) })) })), (0, import_jsx_runtime.jsx)(Tooltip_default, Object.assign({ arrow: true, title: localization.pinToRight }, { children: (0, import_jsx_runtime.jsx)(IconButton_default, Object.assign({ onClick: () => handlePinColumn("right"), size: "small" }, { children: (0, import_jsx_runtime.jsx)(PushPinIcon2, { style: {
    transform: "rotate(-90deg)"
  } }) })) }))] }) }));
};
...
var MRT_ShowHideColumnsMenuItems = ({ allColumns, hoveredColumn, setHoveredColumn, column, table }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ disableRipple: true, ref: menuItemRef, onDragEnter: handleDragEnter, sx: (theme) => ({
    alignItems: "center",
    ...
    py: "6px"
  }) }, { children: (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: {
    display: "flex",
    flexWrap: "nowrap",
    gap: "8px"
...
var MRT_ToggleGlobalFilterButton = (_a) => {
  ...
  return (0, import_jsx_runtime.jsx)(Tooltip_default, Object.assign({ arrow: true, title: (_b = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _b !== void 0 ? _b : localization.showHideSearch }, { children: (0, import_jsx_runtime.jsx)(IconButton_default, Object.assign({ "aria-label": (_c = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _c !== void 0 ? _c : localization.showHideSearch, disabled: !!globalFilter, onClick: handleToggleSearch }, rest, { title: void 0 }, { children: showGlobalFilter ? (0, import_jsx_runtime.jsx)(SearchOffIcon2, {}) : (0, import_jsx_runtime.jsx)(SearchIcon2, {}) })) }));
};
var MRT_ToolbarInternalButtons = ({ table }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Box_default, Object.assign({ sx: {
    alignItems: "center",
    display: "flex",
    zIndex: 3
...
var MRT_ToolbarDropZone = ({ table }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Fade_default, Object.assign({ in: showToolbarDropZone }, { children: (0, import_jsx_runtime.jsx)(Box_default, Object.assign({ className: "Mui-ToolbarDropZone", sx: (theme) => ({
    alignItems: "center",
    ...
    width: "100%",
    zIndex: 4
  }), onDragEnter: handleDragEnter }, { children: (0, import_jsx_runtime.jsx)(Typography_default, Object.assign({ fontStyle: "italic" }, { children: localization.dropToGroupBy.replace("{column}", (_b = (_a = draggingColumn === null || draggingColumn === void 0 ? void 0 : draggingColumn.columnDef) === null || _a === void 0 ? void 0 : _a.header) !== null && _b !== void 0 ? _b : "") })) })) }));
};
...
var MRT_BottomToolbar = ({ table }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Toolbar_default, Object.assign({ variant: "dense" }, toolbarProps, { ref: (node) => {
    ...
    p: "0.5rem",
    width: "100%"
  } }, { children: [renderBottomToolbarCustomActions ? renderBottomToolbarCustomActions({ table }) : (0, import_jsx_runtime.jsx)("span", {}), (0, import_jsx_runtime.jsx)(Box_default, Object.assign({ sx: {
    display: "flex",
    justifyContent: "flex-end",
    position: stackAlertBanner ? "relative" : "absolute",
    right: 0,
...
var MRT_FilterTextField = ({ header, rangeFilterIndex, table }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsxs)(TextField_default, Object.assign({ fullWidth: true, inputProps: {
    ...
    return (0, import_jsx_runtime.jsxs)(MenuItem_default, Object.assign({ sx: {
      display: "flex",
      m: 0,
      alignItems: "center",
      gap: "0.5rem"
    }, value }, { children: [isMultiSelectFilter && (0, import_jsx_runtime.jsx)(Checkbox_default, { checked: ((_a2 = column.getFilterValue()) !== null && _a2 !== void 0 ? _a2 : []).includes(value), sx: { mr: "0.5rem" } }), text2] }), value);
...
var MRT_FilterRangeFields = ({ header, table }) => {
  return (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ sx: { display: "grid", gridTemplateColumns: "6fr 6fr", gap: "1rem" } }, { children: [(0, import_jsx_runtime.jsx)(MRT_FilterTextField, { header, rangeFilterIndex: 0, table }), (0, import_jsx_runtime.jsx)(MRT_FilterTextField, { header, rangeFilterIndex: 1, table })] }));
};
...
var MRT_TableHeadCellFilterLabel = ({ header, table }) => {
  ...
  return (0, import_jsx_runtime.jsx)(Grow_default, Object.assign({ unmountOnExit: true, in: !!column.getFilterValue() && !isRangeFilter || isRangeFilter && // @ts-ignore
  (!!((_b = column.getFilterValue()) === null || _b === void 0 ? void 0 : _b[0]) || !!((_c = column.getFilterValue()) === null || _c === void 0 ? void 0 : _c[1])) }, { children: (0, import_jsx_runtime.jsx)(Box_default, Object.assign({ component: "span", sx: { flex: "0 0" } }, { children: (0, import_jsx_runtime.jsx)(Tooltip_default, Object.assign({ arrow: true, placement: "top", title: filterTooltip }, { children: (0, import_jsx_runtime.jsx)(IconButton_default, Object.assign({ disableRipple: true, onClick: (event) => {
    setShowColumnFilters(true);
    queueMicrotask(() => {
      var _a2, _b2;
...
var MRT_TableHeadCellResizeHandle = ({ header, table }) => {
  ...
  const { density } = getState();
  const { column } = header;
  return (0, import_jsx_runtime.jsx)(Box_default, Object.assign({ className: "Mui-TableHeadCell-ResizeHandle-Wrapper", onDoubleClick: () => {
    setColumnSizingInfo((old) => Object.assign(Object.assign({}, old), { isResizingColumn: false }));
    column.resetSize();
...
var MRT_TableHeadCell = ({ header, table }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(TableCell_default, Object.assign({ align: columnDefType === "group" ? "center" : "left", colSpan: header.colSpan, onDragEnter: handleDragEnter, ref: (node) => {
    ...
    tableCellProps,
    theme: theme2
  })), draggingBorders) }, { children: [header.isPlaceholder ? null : (0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ className: "Mui-TableHeadCell-Content", sx: {
    alignItems: "center",
    display: "flex",
    ...
    position: "relative",
    width: "100%"
  } }, { children: [(0, import_jsx_runtime.jsxs)(Box_default, Object.assign({ className: "Mui-TableHeadCell-Content-Labels", onClick: column.getToggleSortingHandler(), sx: {
    alignItems: "center",
  ...
  } }, { children: [(0, import_jsx_runtime.jsx)(Box_default, Object.assign({ className: "Mui-TableHeadCell-Content-Wrapper", sx: {
...
var MRT_EditCellTextField = ({ cell, showLabel, table }) => {
  ...
  return (0, import_jsx_runtime.jsx)(TextField_default, Object.assign({ disabled: (columnDef.enableEditing instanceof Function ? columnDef.enableEditing(row) : columnDef.enableEditing) === false, fullWidth: true, inputRef: (inputRef) => {
    ...
    return (0, import_jsx_runtime.jsx)(MenuItem_default, Object.assign({ sx: {
      display: "flex",
      m: 0,
      alignItems: "center",
      gap: "0.5rem"
...
var MRT_TableBodyCellValue = ({ cell, table }) => {
  ...
  if (enableFilterMatchHighlighting && columnDef.enableFilterMatchHighlighting !== false && renderedCellValue && allowedTypes.includes(typeof renderedCellValue) && (filterValue && allowedTypes.includes(typeof filterValue) && columnDef.filterVariant === "text" || globalFilter && allowedTypes.includes(typeof globalFilter) && column.getCanGlobalFilter())) {
    ...
    if ((chunks === null || chunks === void 0 ? void 0 : chunks.length) > 1 || ((_b = chunks === null || chunks === void 0 ? void 0 : chunks[0]) === null || _b === void 0 ? void 0 : _b.match)) {
      renderedCellValue = (0, import_jsx_runtime.jsx)("span", Object.assign({ "aria-label": renderedCellValue, role: "note" }, { children: (_c = chunks === null || chunks === void 0 ? void 0 : chunks.map(({ key, match, text: text2 }) => (0, import_jsx_runtime.jsx)(Box_default, Object.assign({ "aria-hidden": "true", component: "span", sx: match ? {
...
var MRT_TableBody = ({ columnVirtualizer, table, virtualColumns, virtualPaddingLeft, virtualPaddingRight }) => {
  ...
  return (0, import_jsx_runtime.jsx)(TableBody_default, Object.assign({}, tableBodyProps, { sx: (theme) => Object.assign({ display: layoutMode === "grid" ? "grid" : "table-row-group", height: rowVirtualizer ? `${rowVirtualizer.getTotalSize()}px` : "inherit", minHeight: !rows.length ? "100px" : void 0, position: "relative" }, (tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.sx) instanceof Function ? tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.sx(theme) : tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.sx) }, { children: (_a = tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.children) !== null && _a !== void 0 ? _a : !rows.length ? (0, import_jsx_runtime.jsx)("tr", Object.assign({ style: { display: layoutMode === "grid" ? "grid" : "table-row" } }, { children: (0, import_jsx_runtime.jsx)("td", Object.assign({ colSpan: table.getVisibleLeafColumns().length, style: {
    ...
    return memoMode === "rows" ? (0, import_jsx_runtime.jsx)(Memo_MRT_TableBodyRow, Object.assign({}, props)) : (0, import_jsx_runtime.jsx)(MRT_TableBodyRow, Object.assign({}, props));
  }) }) }));
};
...
var _defaultExport = MaterialReactTable;
export {
  MRT_AggregationFns,
  MRT_BottomToolbar,
  MRT_CopyButton,
