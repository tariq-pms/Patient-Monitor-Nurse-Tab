...
var Tooltip = React6.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const closeTimer = React6.useRef();
  const enterTimer = React6.useRef();
  const leaveTimer = React6.useRef();
  const touchTimer = React6.useRef();
  ...
  const stopTouchInteraction = React6.useCallback(() => {
...
//# sourceMappingURL=chunk-W2JKATDG.js.map
