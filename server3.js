...
//     const tempPath = `${UPLOAD_FOLDER}/temp-scan.jpg`; // Always overwrite the same file

//     fs.writeFileSync(tempPath, buffer);
//     const result = await processMedicalImage(tempPath);

//     // ✅ Skip deletion completely
//     // Optional: log to track file usage
//     console.log(`✔️ Image saved and processed: ${tempPath}`);
